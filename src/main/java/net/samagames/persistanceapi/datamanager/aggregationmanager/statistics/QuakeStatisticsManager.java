...
public class QuakeStatisticsManager
{
    ...
    public List<LeaderboardBean> getLeaderBoard(String category, DataSource dataSource) throws Exception
    {
        ...
        try
        {
            ...
            // Query construction
            String sql = String.format("select p.name as name, d.%1$s as score from players as p, quake_stats as d where p.uuid = d.uuid order by d.%2$s desc limit 3", category);
