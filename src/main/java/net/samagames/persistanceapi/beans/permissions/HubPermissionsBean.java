...
public class HubPermissionsBean {
    ...
    */
    ...
    public boolean isHubJukeboxLock() {
        return this.hubJukeboxLock;
    }

    // Setters
    public void setHubJukeboxLock(boolean hubJukeboxLock) {
        this.hubJukeboxLock = hubJukeboxLock;
    }

    public boolean isHubJukeboxNext() {
        return this.hubJukeboxNext;
    }

    public void setHubJukeboxNext(boolean hubJukeboxNext) {
        this.hubJukeboxNext = hubJukeboxNext;
    }

    public boolean isHubJukeBoxClear() {
        return this.hubJukeBoxClear;
    }

    public boolean isHubModSlow() {
        return this.hubModSlow;
    }

    public void setHubModSlow(boolean hubModSlow) {
        this.hubModSlow = hubModSlow;
    }

    public boolean isHubModShutup() {
        return this.hubModShutup;
    }

    public void setHubModShutup(boolean hubModShutup) {
        this.hubModShutup = hubModShutup;
    }

    public boolean isHubAdminSign() {
        return this.hubAdminSign;
    }

    public void setHubAdminSign(boolean hubAdminSign) {
        this.hubAdminSign = hubAdminSign;
    }

    public boolean isHubAdminNpc() {
        return this.hubAdminNpc;
    }

    public void setHubAdminNpc(boolean hubAdminNpc) {
        this.hubAdminNpc = hubAdminNpc;
    }

    public boolean isHubAnguille() {
        return this.hubAnguille;
    }

    public void setHubAnguille(boolean hubAnguille) {
        this.hubAnguille = hubAnguille;
    }

    public boolean isHubJukeboxNbs() {
        return this.hubJukeboxNbs;
    }

    public void setHubJukeboxNbs(boolean hubJukeboxNbs) {
        this.hubJukeboxNbs = hubJukeboxNbs;
    }

    public boolean isHubAdminEvacuate() {
        return this.hubAdminEvacuate;
    }

    public void setHubAdminEvacuate(boolean hubAdminEvacuate) {
        this.hubAdminEvacuate = hubAdminEvacuate;
    }

    public boolean isHubAnnounce() {
        return this.hubAnnounce;
    }

    public void setHubAnnounce(boolean hubAnnounce) {
        this.hubAnnounce = hubAnnounce;
    }

    public boolean isHubGadgetsCooldownbypass() {
        return this.hubGadgetsCooldownbypass;
    }

    public void setHubGadgetsCooldownbypass(boolean hubGadgetsCooldownbypass) {
        this.hubGadgetsCooldownbypass = hubGadgetsCooldownbypass;
    }

    public boolean isHubGadgetsNuke() {
        return this.hubGadgetsNuke;
    }

    public void setHubGadgetsNuke(boolean hubGadgetsNuke) {
        this.hubGadgetsNuke = hubGadgetsNuke;
    }

    public boolean isHubJukeboxLimitbypass() {
        return this.hubJukeboxLimitbypass;
    }

    public void setHubJukeboxLimitbypass(boolean hubJukeboxLimitbypass) {
        this.hubJukeboxLimitbypass = hubJukeboxLimitbypass;
    }

    public boolean isHubJukeboxLimitstaff() {
        return this.hubJukeboxLimitstaff;
    }

    public void setHubJukeboxLimitstaff(boolean hubJukeboxLimitstaff) {
        this.hubJukeboxLimitstaff = hubJukeboxLimitstaff;
    }

    public boolean isHubBypassmute() {
        return this.hubBypassmute;
    }

    public void setHubBypassmute(boolean hubBypassmute) {
        this.hubBypassmute = hubBypassmute;
    }

    public boolean isHubFly() {
        return this.hubFly;
    }
    ...
    public boolean isHubDebugSign() {
        return this.hubDebugSign;
    }

    public void setHubDebugSign(boolean hubDebugSign) {
        this.hubDebugSign = hubDebugSign;
    }

    public boolean isHubSignSelection() {
        return this.hubSignSelection;
    }

    public void setHubSignSelection(boolean hubSignSelection) {
        this.hubSignSelection = hubSignSelection;
    }

    public boolean isHubBetaVIP() {
        return this.hubBetaVIP;
    }

    public void setHubBetaVIP(boolean hubBetaVIP) {
        this.hubBetaVIP = hubBetaVIP;
    }

    public boolean isHubAdminPearl() {
        return this.hubAdminPearl;
    }

    public void setHubAdminPearl(boolean hubAdminPearl) {
        this.hubAdminPearl = hubAdminPearl;
    }

    public boolean isHubAnimatingEvent() {
        return this.hubAnimatingEvent;
    }

    public void setHubAnimatingEvent(boolean hubAnimatingEvent) {
        this.hubAnimatingEvent = hubAnimatingEvent;
    }

    public void setHubjukeboxClear(boolean hubJukeBoxClear) {
        this.hubJukeBoxClear = hubJukeBoxClear;
    }
